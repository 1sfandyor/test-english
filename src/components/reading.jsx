        ...
        <div>
            ...
            <div className='container'>
                <div className='card-wrapper flex justify-start gap-x-[22px] items-center flex-wrap gap-y-5 pb-[20px]'>
                    <LessonCards img={red1} text={'A1 Reading Testi'} path={'reading/a1'} />
                    <LessonCards img={red2} text={'A2 Reading Testi'} path={'reading/a2'} />
                    <LessonCards img={red3} text={'B1 Reading Testi'} path={'reading/b1'} />
                    <LessonCards img={red4} text={'B1+ Reading Testi'} path={'reading/b1+'}/>
                    <LessonCards img={red5} text={'B2 Reading Testi'} path={'reading/b2'}/>
                </div>
            </div>
        </div>
    </>
