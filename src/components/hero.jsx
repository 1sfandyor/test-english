...
export default function Hero() {
  return (
    <main className='flex py-[15.3rem] items-center relative z-10'>
        <div className='container'>
            <div className='w-[60%] text-white'>
                <h1 className='text-[50px] font-[600]'>Test-English</h1>
                <h2 className='text-[40px] text-[#50af31] font-[600]'>O&apos;rganayotganlaringizni yoningizda olib yuring </h2>
