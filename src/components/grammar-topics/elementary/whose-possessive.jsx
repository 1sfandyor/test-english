...
export default function WhosePossessive() {
        ...
        <div className='container'>
          ...
          <div className={`my-10 ${hidden}`}>
            ...
            <div className='info my-10'>
              ...
              <h1 className='text-[30px] py-[10px] my-5 text-[#1a8ec1]'><b>be</b>- present simple use</h1>
              
              <div className='w-[55%]'>
                <img className='w-[100%]' src={tobe2} alt="..." />
              </div>
              
              <p className='text-[25px] mb-5'>We use the verb <b>be</b> to talk about:</p>
              
              <ul className='list-disc pl-5 text-[20px] mb-5'>
                <li><b>Who we are:</b> I <i className='text-[#ec6825]'>'m Steven, and this <i className='text-[#ec6825]'>is</i></i> Isabella.</li>
                <li><b>Who we are:</b> I <i className='text-[#ec6825]'>'m Steven, and this <i className='text-[#ec6825]'>is</i></i> Isabella.</li>
                <li><b>Who we are:</b> I <i className='text-[#ec6825]'>'m Steven, and this <i className='text-[#ec6825]'>is</i></i> Isabella.</li>
                <li><b>Who we are:</b> I <i className='text-[#ec6825]'>'m Steven, and this <i className='text-[#ec6825]'>is</i></i> Isabella.</li>
                <li><b>Who we are:</b> I <i className='text-[#ec6825]'>'m Steven, and this <i className='text-[#ec6825]'>is</i></i> Isabella.</li>
