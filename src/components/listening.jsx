        ...
        <div>
            ...
            <div className='container'>
                <div className='card-wrapper flex justify-start gap-x-[22px] items-center flex-wrap gap-y-5 pb-[20px]'>
                    <LessonCards img={lis1} text={'A1 Listening Testlari'} path={'listening/a1'} />
                    <LessonCards img={lis2} text={'A2 Listening Testlari'} path={'listening/a2'} />
                    <LessonCards img={lis3} text={'B1 Listening Testlari'} path={'listening/b1'} />
                    <LessonCards img={lis4} text={'B1+ Listening Testlari'} path={'listening/b1+'} />
                    <LessonCards img={lis5} text={'B2 Listening Testlari'} path={'listening/b2'} />
                </div>
            </div>
        </div>
    </>
